...
export DOP313_SSM_DOCUMENT_ARN=arn:aws:ssm:${REGION}:${ACCOUNT_ID}:document/${DOP313_SSM_DOCUMENT_NAME}
...
EXISTS=$( aws fis list-experiment-templates --query "experimentTemplates[?tags.Name=='${DOP313_TEMPLATE_NAME}'].id" --output text )
